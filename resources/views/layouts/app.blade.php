...
<head>
    ...
    <script src="https://use.fontawesome.com/0627bbb269.js"></script>
    <!-- Fonts -->
...
<body class="body">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-user  shadow-sm">
            <div class="container">
                <a class="navbar-judul nav-text" href="{{ url('/') }}">
